...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		login2.setLoginCliente("User2");
		login2.setSenhaCliente("qwertyuiop");
		login2.setClienteLogin(cliente2);

		Login login3 = new Login();
		login3.setLoginCliente("User3");
		login3.setSenhaCliente("qwertyuiop");
		login3.setClienteLogin(cliente3);

		Login login4 = new Login();
		login4.setLoginCliente("User4");
		login4.setSenhaCliente("qwertyuiop");
		login4.setClienteLogin(cliente4);

		Login login5 = new Login();
		login5.setLoginCliente("User5");
		login5.setSenhaCliente("qwertyuiop");
		login5.setClienteLogin(cliente5);

		Login login6 = new Login();
		login6.setLoginCliente("User6");
		login6.setSenhaCliente("qwertyuiop");
		login6.setClienteLogin(cliente6);

		Login login7 = new Login();
		login7.setLoginCliente("User7");
