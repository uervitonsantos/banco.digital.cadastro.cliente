...
public class DocumentoClienteController {
	 ...
	 * 
	 * @ResponseStatus(HttpStatus.OK) public Cliente atualiza(@RequestBody Cliente
	 * newCliente, @PathVariable Long id) { return
	 * clienteService.atualizarCliente(newCliente, id);
	 * 
	 * }
	 */
